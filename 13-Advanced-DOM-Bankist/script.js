...
tabsContainer.addEventListener("click", function (e) {
  ...
  // Guard clause
  if (!clicked) return; // a more modern way
...
// when the header becomes completely not visible
...
slider.style.overflow = 'visible' */
  ...
  //look for using event delegation instead of adding an event handler to each child - good practice
...
// important method, especially for event delegation
...
}) // thats why we should put the script tag at the end of the HTML
